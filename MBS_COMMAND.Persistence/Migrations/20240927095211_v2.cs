    ...
    public partial class v2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_group_Student_Mappings", x => new { x.GroupId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_group_Student_Mappings_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_group_Student_Mappings_Users_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_group_Student_Mappings_StudentId",
                table: "group_Student_Mappings",
                column: "StudentId");
